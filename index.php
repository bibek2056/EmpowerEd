...
<!-- Navigation Bar -->
	<header id="header">
		<nav>
			<div class="logo"><img src="images/icon/EmpowerEd.png" alt="logo"></div>
			<ul>
...
<!-- Some Popular Subjects -->
	...
	<div class="course">
		...
		<div class="det"><a href="subjects/gate.php"><img src="images/courses/d1.png">GATE Preparation</a></div>
		<div class="det"><a href="subjects/jee.php#sample_papers"><img src="images/courses/paper.png">Sample Papers</a></div>
		<div class="det"><a href="subjects/quiz.php"><img src="images/courses/d1.png">Daily Quiz</a></div>
		</div></center>
		<div class="cbox">
		<div class="det"><a href="subjects/computer_courses.php"><img src="images/courses/computer.png">Computer Courses</a></div>
		<div class="det"><a href="subjects/computer_courses.php#data"><img src="images/courses/data.png">Data Structures</a></div>
		<div class="det"><a href="subjects/computer_courses.php#algo"><img src="images/courses/algo.png">Algorithm</a></div>
		<div class="det det-last"><a href="subjects/computer_courses.php#projects"><img src="images/courses/projects.png">Projects</a></div>
		</div>
	</div>
...
<!-- TEAM -->
	<div class="diffSection" id="team_section">
		...
		<div class="totalcard">
			<div class="card">
				<center><img src="images/creator/bibekadh.jpg"></center>
				<center><div class="card-title">Bibek Adhikari</div>
				<div id="detail">
					...
					<div class="duty"></div>
					<a href="https://www.instagram.com/bibek_adh143/" target="_blank"><button class="btn-bibek">Follow +</button></a>
				</div>
				</center>
			</div>
			<div class="card">
				<center><img src="images/creator/safal.jpg"></center>
				<center><div class="card-title">Safal Rana bhat</div>
				<div id="detail">
					...
					<div class="duty"></div>
					<a href="https://www.instagram.com/ranachhetri07/" target="_blank"><button class="btn-safal">Follow +</button></a>
				</div>
				</center>
			</div>
			<div class="card">
				<center><img src="images/creator/sandesh.jpg"></center>
				<center><div class="card-title">Sandesh Ranabhat</div>
				<div id="detail">
					<p>“ Bringing out the best in our own kids is what true education is all about. The book of human history is the best book ever written. What better books can there be than the book of humanity “</p>
					<div class="duty"></div>
					<a href="https://www.instagram.com/sandesh_rb/" target="_blank"><button class="btn-sandesh">Follow +</button></a>
				</div>
				</center>
			</div>
		</div>
...
<!-- FOOTER -->
	<footer>
		<div class="footer-container">
			<div class="left-col">
				<img src="images/icon/EmpowerEd_black.png" style="width: 200px;">
				<div class="logo"></div>
				...
				<p class="rights-text">Copyright © 2021 Created By Bibek Adhikari, Safal Rana bhat, Sandesh Ranabhat All Rights Reserved.</p>
				<br><p><img src="images/icon/location.png"> Pokhara, kaski<br> Nepal</p><br>
				<p><img src="images/icon/phone.png"> +977-9817163604<br><img src="images/icon/mail.png">&nbsp; empowered95@gmail.com</p>
			</div>
			<div class="right-col">
